...
//    var publishedAtArray = [String]()
    ...
    override func viewDidLoad() {
        super.viewDidLoad()        //✨引っ張って❓更新した時に呼ばれるメソッドとリフレッシュする動作
...
//        cell.imageView?.sd_setImage(with: profileImageURL, completed: nil)
    ...
    func getData(){
        ...
        let text = "https://www.googleapis.com/youtube/v3/search?key=AIzaSyC7-ZBjqNeIsDGAtSCcT6Mjv978G5eD7Z4&q=市民後見人&part=snippet&maxResults=19&order=date"
        
//        let text = "https://www.googleapis.com/youtube/v3/search?key=AIzaSyCRt90CS6GfUttMqx8FdqW6YAG1tH2BLIE&q=iz*One&part=snippet&maxResults=19&order=date"
