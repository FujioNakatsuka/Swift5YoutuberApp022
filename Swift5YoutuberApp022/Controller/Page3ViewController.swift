...
//        cell.imageView?.sd_setImage(with: profileImageURL, completed: nil)
    ...
    func getData(){
        ...
        let text = "https://www.googleapis.com/youtube/v3/search?key=AIzaSyC7-ZBjqNeIsDGAtSCcT6Mjv978G5eD7Z4&q=児童福祉&part=snippet&maxResults=19&order=date"

//        let text = "https://www.googleapis.com/youtube/v3/search?key=AIzaSyCRt90CS6GfUttMqx8FdqW6YAG1tH2BLIE&q=日向坂46&part=snippet&maxResults=19&order=date"
//
