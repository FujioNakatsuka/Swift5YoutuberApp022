...
//        cell.imageView?.sd_setImage(with: profileImageURL, completed: nil)
    ...
    func getData(){
        ...
        let text = "https://www.googleapis.com/youtube/v3/search?key=AIzaSyC7-ZBjqNeIsDGAtSCcT6Mjv978G5eD7Z4&q=新型コロナウイルス対策&part=snippet&maxResults=19&order=date"
        
//        let text = "https://www.googleapis.com/youtube/v3/search?key=AIzaSyCRt90CS6GfUttMqx8FdqW6YAG1tH2BLIE&q=rocket girls 101&part=snippet&maxResults=19&order=date"
//
        ...
        AF.request( url, method:.get , parameters: nil, encoding: JSONEncoding.default).responseJSON{(responce)in
            ...
            for i in 0...19{
                ...
                //videoIdに関連する108、112、115、119行目をコメントアウトするとクラッシュはしない。
